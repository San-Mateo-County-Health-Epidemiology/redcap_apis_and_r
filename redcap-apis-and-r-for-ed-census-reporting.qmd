...
## 5. Back-up: manual entry {background-image="images/blank-slide.png" background-size="contain"}

-   If the API to get the data is down and/or if data are missing and need to be entered manually, the person sending the report will manually enter data in REDCap
...
![](images/section-lessons-learned.jpg){.absolute top="0" left="0" right="0," width="1690"}
...
![](images/section-questions.jpg){.absolute top="0" left="0" right="0," width="1690"}
...
## Windows task scheduler {background-image="images/blank-slide.png" background-size="contain"}

## R Markdown/Quarto {background-image="images/blank-slide.png" background-size="contain"}
